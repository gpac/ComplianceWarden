...
meta_start:
    ...
    iprp_start:
        ...
        ipma_start:
            ...
            db 0x00 ; version(8) 
            db 0x00, 0x00, 0x00 ; flags(24) 
            db 0x00, 0x00, 0x00, 0x09 ; entry_count(32) 
            db 0x00, 0x01 ; item_ID(16) 
