...
meta_start:
    ...
    iloc_start:
        ...
        db 0x00, 0x00 ; data_reference_index(16) 
        db 0x00, 0x00, 0x00, 0x37 ; base_offset(32) 
        db 0x00, 0x01 ; extent_count(16) 
         ; extent_offset(0) 
        db 0x00, 0x00, 0x00, 0x1A ; extent_length(32) 
        db 0x00, 0x06 ; item_ID(16) 
        db 0x00, 0x00 ; data_reference_index(16) 
        db 0x00, 0x00, 0x00, 0x51 ; base_offset(32) 
        db 0x00, 0x01 ; extent_count(16) 
         ; extent_offset(0) 
        db 0x00, 0x00, 0x00, 0x23 ; extent_length(32) 
        db 0x00, 0x07 ; item_ID(16) 
        db 0x00, 0x00 ; data_reference_index(16) 
        db 0x00, 0x00, 0x00, 0x74 ; base_offset(32) 
        db 0x00, 0x01 ; extent_count(16) 
         ; extent_offset(0) 
        db 0x00, 0x00, 0x00, 0x24 ; extent_length(32) 
        db 0x00, 0x08 ; item_ID(16) 
        db 0x00, 0x00 ; data_reference_index(16) 
        db 0x00, 0x00, 0x00, 0x98 ; base_offset(32) 
        db 0x00, 0x01 ; extent_count(16) 
         ; extent_offset(0) 
        db 0x00, 0x00, 0x00, 0x23 ; extent_length(32) 
        db 0x00, 0x09 ; item_ID(16) 
        db 0x00, 0x00 ; data_reference_index(16) 
        db 0x00, 0x00, 0x00, 0xBB ; base_offset(32) 
        db 0x00, 0x01 ; extent_count(16) 
         ; extent_offset(0) 
        db 0x00, 0x00, 0x00, 0x24 ; extent_length(32) 
    iloc_end:
