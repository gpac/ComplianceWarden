...
ftyp_start:
    ...
    dd "ftyp"
    db 0x68, 0x65, 0x69, 0x63 ; "brand(32)" ('heic') 
...
meta_start:
    ...
    iloc_start:
        ...
        db 0x00, 0x00, 0x02, 0x07 ; "extent_offset(32)" 
        db 0x00, 0x00, 0xEC, 0x29 ; "extent_length(32)" 
        db 0x00, 0x02 ; "item_ID(16)" 
        db 0x00, 0x00 ; "data_reference_index(16)" 
        db 0x00, 0x01 ; "extent_count(16)" 
        db 0x00, 0x00, 0xEE, 0x30 ; "extent_offset(32)" 
        db 0x00, 0x00, 0x01, 0x5F ; "extent_length(32)" 
    iloc_end:
meta_end:
mdat_start:
