    ...
    iprp_start:
        ...
        ipco_start:
            ...
            clap_start:
                ...
                db 0x00, 0x00, 0x00, 0x02 ; cleanApertureWidthD(32) 
                db 0x00, 0x00, 0x00, 0x21 ; cleanApertureHeightN(32) 
                db 0x00, 0x00, 0x00, 0x02 ; cleanApertureHeightD(32) 
                db 0x00, 0x00, 0x00, 0x01 ; horizOffN(32) 
                db 0x00, 0x00, 0x00, 0x02 ; horizOffD(32) 
                db 0x00, 0x00, 0x00, 0x01 ; vertOffN(32) 
                db 0x00, 0x00, 0x00, 0x02 ; vertOffD(32) 
            clap_end:
            ispe2_start:
            ...
            av1C_start:
                ...
                db 0x08 ; seq_tier_0(1) high_bitdepth(1) twelve_bit(1) monochrome(1) chroma_subsampling_x(1) chroma_subsampling_y(1) chroma_sample_position(2) 
