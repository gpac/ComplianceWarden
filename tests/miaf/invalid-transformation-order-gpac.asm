...
meta_start:
    ...
    iloc_start:
        ...
        db 0x00, 0x00, 0x03, 0x5E ; base_offset(32) 
        db 0x00, 0x01 ; extent_count(16) 
         ; extent_offset(0) 
        db 0x00, 0x00, 0x00, 0x23 ; extent_length(32) 
        db 0x00, 0x02 ; item_ID(16) 
        db 0x00, 0x00 ; data_reference_index(16) 
        db 0x00, 0x00, 0x03, 0x81 ; base_offset(32) 
        db 0x00, 0x01 ; extent_count(16) 
         ; extent_offset(0) 
        db 0x00, 0x00, 0x00, 0x23 ; extent_length(32) 
        db 0x00, 0x03 ; item_ID(16) 
        db 0x00, 0x00 ; data_reference_index(16) 
        db 0x00, 0x00, 0x03, 0xA4 ; base_offset(32) 
        db 0x00, 0x01 ; extent_count(16) 
         ; extent_offset(0) 
        db 0x00, 0x00, 0x00, 0x1A ; extent_length(32) 
        db 0x00, 0x04 ; item_ID(16) 
        db 0x00, 0x00 ; data_reference_index(16) 
        db 0x00, 0x00, 0x03, 0xBE ; base_offset(32) 
        db 0x00, 0x01 ; extent_count(16) 
         ; extent_offset(0) 
        db 0x00, 0x00, 0x00, 0x23 ; extent_length(32) 
        db 0x00, 0x05 ; item_ID(16) 
        db 0x00, 0x00 ; data_reference_index(16) 
        db 0x00, 0x00, 0x03, 0xE1 ; base_offset(32) 
        db 0x00, 0x01 ; extent_count(16) 
         ; extent_offset(0) 
        db 0x00, 0x00, 0x00, 0x24 ; extent_length(32) 
        db 0x00, 0x06 ; item_ID(16) 
        db 0x00, 0x00 ; data_reference_index(16) 
        db 0x00, 0x00, 0x04, 0x05 ; base_offset(32) 
        db 0x00, 0x01 ; extent_count(16) 
         ; extent_offset(0) 
        db 0x00, 0x00, 0x00, 0x23 ; extent_length(32) 
        db 0x00, 0x07 ; item_ID(16) 
        db 0x00, 0x00 ; data_reference_index(16) 
        db 0x00, 0x00, 0x04, 0x28 ; base_offset(32) 
        db 0x00, 0x01 ; extent_count(16) 
         ; extent_offset(0) 
        db 0x00, 0x00, 0x00, 0x24 ; extent_length(32) 
        db 0x00, 0x08 ; item_ID(16) 
        db 0x00, 0x00 ; data_reference_index(16) 
        db 0x00, 0x00, 0x04, 0x4C ; base_offset(32) 
        db 0x00, 0x01 ; extent_count(16) 
         ; extent_offset(0) 
        db 0x00, 0x00, 0x00, 0x24 ; extent_length(32) 
        db 0x00, 0x09 ; item_ID(16) 
        db 0x00, 0x00 ; data_reference_index(16) 
        db 0x00, 0x00, 0x04, 0x70 ; base_offset(32) 
        db 0x00, 0x01 ; extent_count(16) 
         ; extent_offset(0) 
        db 0x00, 0x00, 0x00, 0x08 ; extent_length(32) 
        db 0x00, 0x0A ; item_ID(16) 
        db 0x00, 0x00 ; data_reference_index(16) 
        db 0x00, 0x00, 0x04, 0x78 ; base_offset(32) 
        db 0x00, 0x01 ; extent_count(16) 
         ; extent_offset(0) 
        db 0x00, 0x00, 0x00, 0x08 ; extent_length(32) 
        db 0x00, 0x0B ; item_ID(16) 
        db 0x00, 0x00 ; data_reference_index(16) 
        db 0x00, 0x00, 0x04, 0x80 ; base_offset(32) 
        db 0x00, 0x01 ; extent_count(16) 
         ; extent_offset(0) 
