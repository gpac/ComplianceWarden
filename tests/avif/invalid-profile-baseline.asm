    ...
    iprp_start:
        ...
        ipco_start:
            ...
            av1C_start:
                ...
                db 0x2E ; seq_profile(1) seq_level_idx_0(14) 
                db 0x40 ; seq_tier_0(1) high_bitdepth(1) twelve_bit(1) monochrome(1) chroma_subsampling_x(1) chroma_subsampling_y(1) chroma_sample_position(2) 
