...
tkhd_start:
    ...
    db 0x00, 0x00, 0x04, 0xB4 ; width(32) 
    db 0x00, 0x00, 0x03, 0x20 ; height(32) 
tkhd_end:
...
av01_start:
    ...
    av1C3_start:
        ...
        db 0x4C ; seq_tier_0(1) high_bitdepth(1) twelve_bit(1) monochrome(1) chroma_subsampling_x(1) chroma_subsampling_y(1) chroma_sample_position(2) 
