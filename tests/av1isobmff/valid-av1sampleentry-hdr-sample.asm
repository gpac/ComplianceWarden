...
tkhd_start:
    ...
    db 0x10, 0x00, 0x00, 0x00 ; width(32) 
    db 0x08, 0x70, 0x00, 0x00 ; height(32) 
tkhd_end:
...
av01_start:
    ...
    mdcv_start:
        ...
        dd "mdcv"
        db 0x00, 0x00 ; display_primaries_x[0](16)
        db 0x00, 0x00 ; display_primaries_y[0](16)
        db 0x00, 0x00 ; display_primaries_x[1](16)
        db 0x00, 0x00 ; display_primaries_y[1](16)
        db 0x00, 0x00 ; display_primaries_x[2](16)
        db 0x00, 0x00 ; display_primaries_y[2](16)
        db 0x00, 0x00 ; white_point_x(16)
        db 0x00, 0x00 ; white_point_y(16)
        db 0x00, 0x00, 0x00, 0x00 ; max_display_mastering_luminance(32)
        db 0x00, 0x00, 0x00, 0x00 ; min_display_mastering_luminance(32)
    mdcv_end:
    clli_start:
        dd BE(clli_end - clli_start)
        dd "clli"
        db 0x00, 0x00 ; max_content_light_level(16)
        db 0x00, 0x00 ; max_pic_average_light_level(16)
    clli_end:
av01_end:
...
sgpd_start:
    dd BE(sgpd_end - sgpd_start)
    dd "sgpd"
    db 0x00 ; version(8) 
    db 0x00, 0x00, 0x00 ; flags(24) 
    db 0x61, 0x76, 0x31, 0x4D ; grouping_type(32)
    db 0x00, 0x00, 0x00, 0x01 ; entry_count(32)
    db 0x00 ; metadata_type(8)
...
mdat_start:
    ...
    db 0x40 ; film_grain_params_present(1) ('@') bits(7) ('@') 
     ...
     ; obu(0)
     ; metadata(0)
    db 0x2A ; forbidden(1) ('*') obu_type(4) (5) obu_extension_flag(1) (0) obu_has_size_field(1) (1) obu_reserved_1bit(1) ('*')
    db 0x19 ; leb128_byte(8)
    db 0x02 ; metadata_type(8) ('MDCV')
    db 0x00, 0x00 ; primary_chromaticity_x[0](16)
    db 0x00, 0x00 ; primary_chromaticity_y[0](16)
    db 0x00, 0x00 ; primary_chromaticity_x[1](16)
    db 0x00, 0x00 ; primary_chromaticity_y[1](16)
    db 0x00, 0x00 ; primary_chromaticity_x[2](16)
    db 0x00, 0x00 ; primary_chromaticity_y[3](16)
    db 0x00, 0x00 ; white_point_chromaticity_x(16)
    db 0x00, 0x00 ; white_point_chromaticity_y(16)
    db 0x00, 0x00, 0x00, 0x00 ; luminance_max(32)
    db 0x00, 0x00, 0x00, 0x00 ; luminance_min(32)
     ; /metadata(0)
     ; /obu(0)
     ; obu(0)
     ; metadata(0)
    db 0x2A ; forbidden(1) ('*') obu_type(4) (5) obu_extension_flag(1) (0) obu_has_size_field(1) (1) obu_reserved_1bit(1) ('*')
    db 0x05 ; leb128_byte(8)
    db 0x01 ; metadata_type(8) ('CLLI')
    db 0x00, 0x00 ; max_cll(16)
    db 0x00, 0x00 ; max_fall(16)
     ; /metadata(0)
     ; /obu(0)
     ; obu(0)
     ; metadata(0)
