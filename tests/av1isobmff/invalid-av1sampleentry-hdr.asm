...
av01_start:
    ...
    mdcv_start:
        ...
        dd "mdcv"
        db 0x01, 0x01 ; display_primaries_x[0](16)
        db 0x01, 0x01 ; display_primaries_y[0](16)
        db 0x01, 0x01 ; display_primaries_x[1](16)
        db 0x01, 0x01 ; display_primaries_y[1](16)
        db 0x01, 0x01 ; display_primaries_x[2](16)
        db 0x01, 0x01 ; display_primaries_y[2](16)
        db 0x01, 0x01 ; white_point_x(16)
        db 0x01, 0x01 ; white_point_y(16)
        db 0x01, 0x01, 0x01, 0x01 ; max_display_mastering_luminance(32)
        db 0x01, 0x01, 0x01, 0x01 ; min_display_mastering_luminance(32)
    mdcv_end:
    clli_start:
        dd BE(clli_end - clli_start)
        dd "clli"
        db 0x01, 0x01 ; max_content_light_level(16)
        db 0x01, 0x01 ; max_pic_average_light_level(16)
    clli_end:
av01_end:
