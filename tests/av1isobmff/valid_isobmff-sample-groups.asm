...
stsc_start:
    ...
    db 0x00, 0x00, 0x00, 0x01 ; first_chunk(32)
    db 0x00, 0x00, 0x00, 0x01 ; samples_per_chunk(32)
    db 0x00, 0x00, 0x00, 0x01 ; sample_description_index(32)
    db 0x00, 0x00, 0x00, 0x01 ; first_chunk(32)
    db 0x00, 0x00, 0x00, 0x01 ; samples_per_chunk(32)
    db 0x00, 0x00, 0x00, 0x02 ; sample_description_index(32)
stsc_end:
stsz_start:
...
stco_start:
    ...
    dd BE(mdat2_start - ftyp_start + 8) ; chunk_offset(32) 
stco_end:
...
sgpd_start:
    ...
    db 0x00 ; version(8) 
    db 0x00, 0x00, 0x00 ; flags(24) 
    db 0x61, 0x76, 0x31, 0x66 ; grouping_type(32) ('av1f')
    db 0x00, 0x00, 0x00, 0x01 ; entry_count(32)
sgpd_end:
...
sgpd2_start:
    dd BE(sgpd2_end - sgpd2_start)
    dd "sgpd"
    db 0x00 ; version(8) 
    db 0x00, 0x00, 0x00 ; flags(24) 
    db 0x61, 0x76, 0x31, 0x73 ; grouping_type(32) ('av1s')
    db 0x00, 0x00, 0x00, 0x01 ; entry_count(32)
sgpd2_end:

sbgp2_start:
    dd BE(sbgp2_end - sbgp2_start)
    dd "sbgp"
    db 0x00 ; version(8) 
    db 0x00, 0x00, 0x00 ; flags(24) 
    db 0x61, 0x76, 0x31, 0x73 ; grouping_type(32) ('av1s')
    db 0x00, 0x00, 0x00, 0x02 ; entry_count(32)
    db 0x00, 0x00, 0x00, 0x01 ; sample_count(32)
    db 0x00, 0x00, 0x00, 0x00 ; group_description_index(32)
    db 0x00, 0x00, 0x00, 0x01 ; sample_count(32)
    db 0x00, 0x00, 0x00, 0x01 ; group_description_index(32)
sbgp2_end:

sgpd3_start:
    dd BE(sgpd3_end - sgpd3_start)
    dd "sgpd"
    db 0x00 ; version(8) 
    db 0x00, 0x00, 0x00 ; flags(24) 
...
sbgp3_start:
    dd BE(sbgp3_end - sbgp3_start)
    dd "sbgp"
    db 0x00 ; version(8) 
    db 0x00, 0x00, 0x00 ; flags(24) 
    db 0x61, 0x76, 0x31, 0x4D ; grouping_type(32) ('av1M')
    db 0x00, 0x00, 0x00, 0x01 ; entry_count(32)
    db 0x00, 0x00, 0x00, 0x02 ; sample_count(32)
    db 0x00, 0x00, 0x00, 0x01 ; group_description_index(32)
sbgp3_end:
...
mdat_start:
    ...
    db 0x00, 0x01 ; itu_t_t35_terminal_provider_oriented_code(16) 
     ; obu(0) 
    db 0x1E ; forbidden(1) obu_type(4) ('3') obu_extension_flag(1) obu_has_size_field(1) obu_reserved_1bit(1) 
    db 0x00 ; obu_extension_flag(8)
    db 0x01 ; leb128_byte(8) 
    db 0x00 ; show_existing_frame(1) frame_type(2) show_frame(1) bits(4)
     ; obu(0) 
...
mdat2_start:
    ...
    db 0x00 ; obu_extension_flag(8)
    db 0x01 ; leb128_byte(8) 
    db 0x60 ; show_existing_frame(1) frame_type(2) show_frame(1) bits(4)
     ; obu(0) 
    db 0x32 ; forbidden(1) ('2') obu_type(4) ('2') obu_extension_flag(1) ('2') obu_has_size_field(1) ('2') obu_reserved_1bit(1) ('2') 
    db 0x01 ; leb128_byte(8) 
    db 0x80 ; show_existing_frame(1) frame_to_show_map_idx(3) bits(4) 
