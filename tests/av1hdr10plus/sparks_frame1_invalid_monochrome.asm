...
_start:
    ...
    db 0xF0, 0x91, 0x00, 0x94 ; enable_restoration(1) high_bitdepth(1) mono_chrome(1) color_description_present_flag(1) color_primaries(8) transfer_characteristics(8) matrix_coefficients(8) color_range(1) separate_uv_delta_q(0) film_grain_params_present(1) bits(2) 
     ; /seqhdr(0) 
    db 0x40 ; byte(8) ('@') 
     ; obu(0) 
