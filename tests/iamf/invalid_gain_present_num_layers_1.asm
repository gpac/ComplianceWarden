...
; Audio Element OBU (Invalid: num_layers=1 but output_gain_is_present_flag=1 and recon_gain_is_present_flag=1)
...
db 00001100b ; loudspeaker_layout = 0 (Mono), output_gain_is_present_flag = 1, recon_gain_is_present_flag = 1
db 1         ; substream_count = 1
db 0         ; coupled_substream_count = 0
db 0         ; output_gain_flags = 0
