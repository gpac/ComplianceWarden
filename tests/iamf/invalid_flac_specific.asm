...
; Codec Config OBU (Invalid fLaC specific fields)
obu_1_start:
...
; STREAMINFO payload
db 0, 32     ; minimum_block_size = 32 -> INVALID (should be 64)
db 0, 32     ; maximum_block_size = 32 -> INVALID (should be 64)
db 0, 0, 100 ; minimum_frame_size = 100 -> INVALID (should be 0)
db 0, 0, 100 ; maximum_frame_size = 100 -> INVALID (should be 0)
db 0x0B, 0xB8, 0x00, 0xF0 ; sr = 48000, ch = 0 (mono) -> INVALID (should be 1), bps = 15 (16-bit)
db 0, 0, 0, 0 ; total_samples = 0 (low 32 bits)
db 1         ; MD5 signature = non-zero -> INVALID (should be 0)
times 15 db 0
obu_1_end:
