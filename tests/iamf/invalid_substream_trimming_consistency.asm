...
; OBU 1: Codec Config OBU (Valid Opus)
obu_1_start:
...
; OBU 2: Valid Audio Element (Scene Based, 2 substreams)
obu_2_start:
...
; OBU 4: Audio Frame OBU for substream 18 with trimming (312)
db 00101010b ; OBU Header: obu_type = 5 (Audio Frame), redundant_copy = 0, trimming = 1, extension = 0
db 5         ; obu_size = 5 bytes
db 0         ; num_samples_to_trim_at_end = 0
db 0xB8, 0x02 ; num_samples_to_trim_at_start = 312
db 18        ; explicit_audio_substream_id = 18
db 0         ; dummy audio frame byte

; OBU 5: Audio Frame OBU for substream 19 with DIFFERENT trimming (0)
db 00101000b ; OBU Header: obu_type = 5 (Audio Frame), redundant_copy = 0, trimming = 0, extension = 0
db 2         ; obu_size = 2 bytes
db 19        ; explicit_audio_substream_id = 19
db 0         ; dummy audio frame byte
