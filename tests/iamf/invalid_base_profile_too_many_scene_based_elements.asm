...
; Audio Element OBU 1: Valid Ambisonics Config (MONO)
obu_1_start:
...
; INVALID: There are 2 scene-based elements which is not allowed in base profile
; Audio Element OBU 2: Valid Ambisonics Config (MONO)
obu_2_start:
db 00001000b ; OBU Header: obu_type = 1 (Audio Element)
...
db 0         ; codec_config_id = 0
db 4         ; num_substreams = 4
db 5, 6, 7, 8 ; audio_substream_ids
db 0         ; num_parameters = 0
db 0         ; ambisonics_mode = 0 (MONO)
db 4         ; output_channel_count = 4
db 4         ; substream_count = 4
...
; Mix Presentation OBU: Valid, references both audio elements
obu_3_start:
