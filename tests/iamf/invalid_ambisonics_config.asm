...
; OBU 2: Tests "ambisonics_mode SHALL be 0 or 1."
obu_2_start:
...
; OBU 3: Tests "output_channel_count SHALL be (1 + n)^2"
obu_3_start:
db 00001000b ; OBU Header: obu_type = 1 (Audio Element)
...
; OBU 4: Tests "substream_count SHALL be the same as num_substreams in this OBU."
obu_4_start:
db 00001000b ; OBU Header: obu_type = 1 (Audio Element)
...
; OBU 5: Tests "For PROJECTION mode, coupled_substream_count SHALL be less than or equal to substream_count."
obu_5_start:
db 00001000b ; OBU Header: obu_type = 1 (Audio Element)
